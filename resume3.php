                ...
                <section id = "preview-sc right-side" class = "print_area">
                    <div class = "container">
                        <div class = "preview-cnt">
                            <div class = "preview-cnt-l bg-blue-mid text-white">
                                <div class = "preview-blk">
                                    <div class = "preview-image">
                                        <img src = "" alt = "" id = "image_dsp"> 
                                    </div>
                                    <div class = "preview-item preview-item-name">
                                        <span class = "preview-title position fw-6" id = "fullname_dsp"></span>
                                    </div>
                                ...
                                <div class = "preview-blk">
                                    ...
                                    <div class = "preview-blk-list">
                                        <div class = "preview-item">
                                            <span class = "preview-title" id = "phoneno_dsp"></span>
                                        </div>
                                        <div class = "preview-item">
                                            <span class = "preview-title" id = "email_dsp"></span>
                                        </div>
                                        <div class = "preview-item">
                                            <span class = "preview-title" id = "address_dsp"></span><br>
                                        </div>
                                        <div class = "preview-item">
                                            <span class = "preview-title" id = "summary_dsp"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class = "preview-blk">
                                    ...
                                    <div class = "skills-items preview-title" id = "skills_dsp">
                                        <!-- skills list here -->
                                    </div>
                                </div>
                            </div>
